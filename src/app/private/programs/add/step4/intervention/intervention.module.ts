...
@NgModule({
  ...
  imports: [DragDropModule, SharedModule, ComponentsModule, CommonModule],
  exports: [InterventionComponent, NavbarComponent, CanvasComponent, InterventionItemComponent],
})
